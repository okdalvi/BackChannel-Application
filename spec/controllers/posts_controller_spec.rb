...
describe PostsController do
  ...
  def invalid_post_attributes
    {
        :content => "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
    }
  end
  ...
  def valid_user_attribute
    {
        :username => "user_trial",
        :password => "foobar",
        :email =>  "user_trial@sample.com",
        :admin => 0
    }
  end
